...
# Google Maps (client-side JS key, restricted by referrer; keep empty by default)
GOOGLE_MAPS_JS_API_KEY = env("GOOGLE_MAPS_JS_API_KEY", default="")
...
LOGIN_REDIRECT_URL = "protected_home"
...
ADMINS = [("""Amilcar Benitez Pietroboni en Dumanity""", "amilcarben@gmail.com")]
...
SPECTACULAR_SETTINGS = {
    "TITLE": "GeoQR API",
    "DESCRIPTION": "Documentation of API endpoints of GeoQR",
    "VERSION": "1.0.0",
...
WP_VAPID_PUBLIC_KEY = env("WP_PUBLIC_KEY", default="")
WP_VAPID_SUBJECT = env(
    "WP_VAPID_SUBJECT",
    default=f"mailto:{ADMINS[0][1]}" if ADMINS else "",
)

PUSH_NOTIFICATIONS_SETTINGS = {
    "WP_PRIVATE_KEY": env("WP_PRIVATE_KEY", default=""),
    "WP_CLAIMS": {"sub": WP_VAPID_SUBJECT},
    "WP_ERROR_TIMEOUT": env.int("WP_ERROR_TIMEOUT", default=1),
}
